...
<section className="svc-hero">
  <div className="wrap">
    <nav className="crumbs" aria-label="Breadcrumb">
      <a href="/">Home</a><span>/</span><b>Onboarding Guide</b>
    </nav>
    <div className="svc-hero-grid">
      <div>
        <span className="eyebrow">Onboarding Guide</span>
        <h1>Six stages, three named people, and no surprises</h1>
        <p className="lede">You are assigned a certified project manager and an account manager as your single point of contact &mdash; and an independent customer success team whose only job is to make sure that relationship is working. We believe in a personal touch and in people success first.</p>
        <div className="svc-cta">
          <a className="btn btn-primary" href="/#contact">Start a conversation <svg><use href="#i-arrow-r"/></svg></a>
          <a className="btn btn-ghost" href="/why-us/our-approach">Read our approach <svg><use href="#i-arrow-r"/></svg></a>
        </div>
      </div>
      <aside className="glance">
        <h2>What you get</h2>
        <ul>
          <li><svg><use href="#i-check"/></svg><span>A PMP-certified project manager, named from day one</span></li>
          <li><svg><use href="#i-check"/></svg><span>An account manager as your single point of contact</span></li>
          <li><svg><use href="#i-check"/></svg><span>An independent customer success team checking on both</span></li>
          <li><svg><use href="#i-check"/></svg><span>A written plan with owners and dates on both sides</span></li>
          <li><svg><use href="#i-check"/></svg><span>A 90-day checklist you can hold us to</span></li>
        </ul>
      </aside>
    </div>
    <div className="svc-stats">
      <div className="svc-stat"><b>3</b><span>Named contacts</span></div>
      <div className="svc-stat"><b>6</b><span>Onboarding stages</span></div>
      <div className="svc-stat"><b>90 days</b><span>To a checklist you can hold us to</span></div>
